...
# 
# Last modified by Claas Abert, 2014-06-13
...
class FredkinKoehler(LLGTerm):
  ...
  def calculate(self, state):
    ...
    *Arguments*
    ...
    rhs_coeffs = []
    for coeff in self.rhs_coeffs(state):
    ...
    u1 = self.calculate_u1(rhs_coeffs, cache.V)
