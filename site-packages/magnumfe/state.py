...
from dolfin import MeshFunction, Measure, FunctionSpace, VectorFunctionSpace, \
    Expression, Constant, interpolate, Constant, FunctionSpaceBase
...
class State(object):
  def __init__(self, mesh, celldomains = {'magnetic': 1}, facetdomains = { }, material = None, **kwargs):
    self.mesh    = mesh
  ...
  def FunctionSpace(self, mesh = None):
