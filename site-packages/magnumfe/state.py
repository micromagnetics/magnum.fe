...
class State(object):
  def __init__(self, mesh, celldomains = {'magnetic': 1, 'conducting': 1}, facetdomains = { }, material = None, **kwargs):
    ...
    *Example*
      .. code-block:: python
        ...
        state.mateiral['conducting'] = Material(...)

        # Use integration measures with named domains
        assemble(Constant(1.0) * state.dx('all'))       # Everywhere
  ...
  def dx(self, domain = "all", dx = None):
    """
    Convenience wrapper for integral-cell measure.
  ...
  def ds(self, domain = "all", ds = None):
    """
    Convenience wrapper for integral-facet measure.
  ...
  def dS(self, domain = "all", dS = None):
    """
    Convenience wrapper for integral-interior-facet measure.
